...
const ResetPasswordPageContent = () => {
  ...
  return (
    <main className="flex flex-col px-10 py-4 bg-white text-black h-screen mx-auto w-full items-center justify-center">
      {isPasswordResetSuccess ? (
        <ResetPasswordSuccess />
      ) : (
        <div className="flex flex-col justify-center items-center gap-8 md:w-1/2 w-full p-8 py-6 rounded-lg shadow-sm">
