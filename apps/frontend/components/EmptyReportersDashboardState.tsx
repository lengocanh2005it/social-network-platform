...
interface EmptyReportersDashboardStateProps {
  hasActiveFilter: boolean;
  onClearFilter?: () => void;
}

const EmptyReportersDashboardState: React.FC<
  EmptyReportersDashboardStateProps
      ...
      <div>
        ...
        <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">
          {hasActiveFilter
            ...
            : "There are no reporters to display at the moment."}
        </p>
      </div>
...
export default EmptyReportersDashboardState;
