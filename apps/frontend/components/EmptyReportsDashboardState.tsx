...
interface EmptyReportsDashboardStateProps {
  hasActiveFilter: boolean;
  onClearFilter?: () => void;
}

const EmptyReportsDashboardState: React.FC<EmptyReportsDashboardStateProps> = ({
  hasActiveFilter,
  onClearFilter,
}) => {
  return (
...
export default EmptyReportsDashboardState;
